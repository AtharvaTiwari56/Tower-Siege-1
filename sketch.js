...
function preload() {
  polygonimg = loadImage("fhbsljg.png");
}
...
function setup() {
  ...
  polygon = Bodies.circle(250, 125, 15, {isStatic: false, density: 0.00001, friction : 0.0001});
  slingshot = new  Sling(polygon, {x: 200, y: 125});
